...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-099-0061"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-v1",
      "problem_contract_sha256": "d3137404b0006bbcc616daa9ffcb3b2f621a76898bdad4c882d1627f85dd9fe8",
      "problem_id": "problem:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd",
      "route_id": "route:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-source-fidelity-01",
      "graph_id": "graph:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a family $(G_n)$ of finite $d$-regular graphs with $|G_n|\\to\\infty$ and a constant $h>0$ such that every induced metric ball in every $G_n$ has edge-expansion constant at least $h$?"
          },
          "statement_sha256": "2db2037afb930e1cfe1239c6d4c39c474fe8164836647b0eb1f736b985195ab0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-root",
      "route_id": "route:um-amr-099-0061-finite-graphs-whose-every-ball-is-an-e-79afefbd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-099-0061-21c6b5d82a4c",
        "url": "https://www.unsolvedmath.com/problems/AMR-099-0061"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
